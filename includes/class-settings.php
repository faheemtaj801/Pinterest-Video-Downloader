...
class PD_Settings {
	...
	public static function get( $key = null ) {
		$defaults = array(
			...
			'terms_url'         => 'https://clickpin.org/terms-of-service/',
	...
	public function sanitize_settings( $input ) {
		...
		$clean['site_name']        = sanitize_text_field( $input['site_name'] ?? 'ClickPin' );
	...
	public function render_settings_page() {
		...
		<div class="wrap pd-admin-wrap">
			...
			<h1>
				<img src="<?php echo esc_url( $logo_url ); ?>" alt="ClickPin" />
				ClickPin — Settings
			</h1>
				...
				<div class="pd-section">
					...
					<div class="pd-field-row">
						...
						<input type="text" id="pd_site_name" name="<?php echo self::OPTION_NAME; ?>[site_name]"
							value="<?php echo esc_attr( $opts['site_name'] ); ?>" placeholder="ClickPin" />
					</div>
